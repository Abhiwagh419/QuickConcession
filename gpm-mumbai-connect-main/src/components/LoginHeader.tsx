...
const LoginHeader = () => {
  return <header className="header-gradient py-4 px-6 shadow-lg">
      <div className="container mx-auto flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col text-header-foreground">
            ...
            <span className="text-sm text-header-foreground/80 leading-tight">An Autonomous Institute of Government of Maharashtra
          </span>
          </div>
        </div>
