      ...
      <PageWrapper>
        <main className="container mx-auto px-4 py-8">
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <span
              className={`px-4 py-1.5 rounded-full text-sm font-medium border ${getStatusBadge(application.status)}`}
            >
              {application.status}
            </span>
          </div>
                  ...
                  application.concessionNumber && (
                    <>
                      ...
                      <div className="p-4 bg-success/10 rounded-lg border border-success/30">
                        <p className="text-xs text-success uppercase tracking-wide mb-2">
                          Issued Details
                        </p>
                        <div className="space-y-2 text-sm">
                          <p>
                ...
                {application.status === "REJECTED" && (
                  <>
                    ...
                    <div className="p-4 bg-destructive/10 rounded-lg border border-destructive/30">
                      <p className="text-xs text-destructive uppercase tracking-wide mb-2">
                        Rejection Details
                      </p>
                ...
                {!showIssueSection ? (
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="max-w-md">
                      <Label htmlFor="concessionNumber">
                        Concession Form Number (from physical form)
                      </Label>
                      <Input
                        id="concessionNumber"
                    ...
                    <p className="text-sm text-muted-foreground">
                      ...
                      concession is issued. Collect it from counter between 2 PM
                      – 4 PM."
                    </p>
                  </div>
                )}
