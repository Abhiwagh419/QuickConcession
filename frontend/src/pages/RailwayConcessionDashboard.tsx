                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      <span
                        className={`px-3 py-1 rounded-full text-sm font-medium border ${getStatusBadge(currentApplication.status)}`}
                      >
              ...
              {hasActivePass && (
                <div className="mt-4 p-3 bg-warning/10 border border-warning/30 rounded-lg">
                  <p className="text-sm text-warning">
                    <strong>Note:</strong> You cannot apply for a new concession
                    while you have an active pass or pending application.
                  </p>
                </div>
              )}
            </CardContent>
                    ...
                    {applications.length === 0 ? (
                      ...
                      applications.map((app) => (
                        <TableRow key={app.id} className="hover:bg-muted/30">
                          ...
                          <TableCell>
                            <span
                              className={`px-2 py-1 rounded text-xs font-medium border ${getStatusBadge(app.status)}`}
                            >
                              {app.status}
                            </span>
                          </TableCell>
