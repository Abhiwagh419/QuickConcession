        ...
        <main className="container mx-auto px-4 py-6 max-w-3xl">
          ...
          <div className="mt-4 p-4 bg-secondary/50 rounded-lg border">
            <p className="text-xs text-muted-foreground">
              <strong className="text-foreground">Note:</strong> Name,
              Enrollment Number, and Date of Birth cannot be changed. Please
              contact the administration office for any corrections to these
              fields.
            </p>
          </div>
        </main>
