...
import { KeyRound, Mail, ArrowLeft, Loader2, CheckCircle2, AlertCircle, Eye, EyeOff, Shield } from "lucide-react";
        ...
        <div className="w-full max-w-md space-y-6">
          ...
          <div className="bg-primary/5 rounded-lg p-4 border border-primary/10">
            <p className="text-xs text-muted-foreground text-center">
              ...
              please check your spam folder or contact the IT department for assistance.
            </p>
          </div>
        </div>
      </main>
