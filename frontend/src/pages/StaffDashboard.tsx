  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          ...
          <Card className="border shadow-sm">
            <CardContent className="pt-4 pb-4">
              ...
              <p className="text-2xl font-heading font-bold text-success">{approvedCount}</p>
            </CardContent>
          </Card>
          <Card className="border shadow-sm">
            <CardContent className="pt-4 pb-4">
              <p className="text-xs text-muted-foreground uppercase tracking-wide">Rejected</p>
              <p className="text-2xl font-heading font-bold text-destructive">{rejectedCount}</p>
            </CardContent>
          </Card>
          <Card className="border shadow-sm">
            <CardContent className="pt-4 pb-4">
              <p className="text-xs text-muted-foreground uppercase tracking-wide">Issued</p>
              <p className="text-2xl font-heading font-bold text-primary">{issuedCount}</p>
            </CardContent>
          </Card>
        </div>
        ...
        <Card className="border shadow-sm">
          <CardHeader>
            <CardTitle className="font-heading text-lg">Administrative Modules</CardTitle>
          </CardHeader>
          <CardContent>
